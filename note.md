# Vào các branch riêng theo từng lớp để biết tiến độ học tập.
...
- Giới thiệu 2 đối tượng request, responsive và các thành phần quan trọng của chúng(path, Method, params, body, query, status…)
...
- Mongo Atlas: Giới thiệu, đăng ký, triển khai
